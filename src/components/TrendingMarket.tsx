      ...
      <div className="flex flex-col md:flex-row gap-6 ">
        <div className="bg-gradient-to-b from-[#111] to-[#0a0a0a] rounded-xl p-6 shadow-lg flex-1">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-white text-3xl font-bold">Trending Markets</h2>
          ...
          {data.map((item) => (
            <div
              ...
              key={item.id}
            >
              <div className="text-gray-500 font-mono mr-5 w-4 text-center">
                {item.id}
              </div>
              ...
              <div className="flex-1 mr-4">
                <p className="text-white font-mono text-sm md:text-base group-hover:text-orange-100 transition-colors duration-300">
                  {item.title}
                </p>
              </div>
              <div className="text-orange-500 font-mono text-sm md:text-base group-hover:text-orange-400 group-hover:scale-105 transition-all duration-300">
                {item.value}
              </div>
            </div>
          ))}
