...
const AppleTimePicker: React.FC<AppleTimePickerProps> = ({
  ...
  return (
    <div className="w-full relative" ref={containerRef} style={{ zIndex: isOpen ? 60 : 'auto' }}>
      <label className="block text-gray-300 font-medium mb-2 text-sm">
        End Time 
        {timezone && <span className="text-xs text-gray-500 ml-1">({timezone})</span>}
      </label>
      ...
      <button
        ...
        className={`w-full bg-[#111] border border-zinc-800 rounded-lg px-4 py-3 text-sm sm:text-base text-left focus:outline-none focus:ring-2 focus:ring-orange-600/50 transition-all duration-300 shadow-inner hover:border-orange-600/50 ${
          date && time ? 'text-white' : 'text-gray-500'
        }`}
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-full left-0 right-0 mb-2 z-50 bg-gradient-to-b from-[#111] to-[#0a0a0a] border border-zinc-800 rounded-xl shadow-2xl p-3 mx-auto max-w-xs"
          >
            {/* Header */}
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center justify-between mb-3">
                <button
                  ...
                  className="p-1.5 rounded-lg hover:bg-zinc-800/50 text-gray-400 hover:text-white transition-all"
                >
                  <ChevronLeft size={16} />
                </button>
                  ...
                  return (
                    ...
                    >
                      ...
                      {isToday(day) && !isSelected(day) && (
                        <div className="absolute bottom-0.5 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-orange-500 rounded-full" />
                      )}
                    </motion.button>
                  );
                })}
            ...
            <div className="border-t border-zinc-800 pt-3">
              <div className="flex items-center justify-center gap-2">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <select
                    ...
                    className="bg-zinc-800 border border-zinc-700 rounded-md px-1.5 py-1 text-white text-center focus:outline-none focus:ring-2 focus:ring-orange-600/50 transition-all text-xs w-12"
                  >
                ...
                <div className="text-white text-lg font-bold mt-5">:</div>
                  ...
                  <div className="flex bg-zinc-800 border border-zinc-700 rounded-lg overflow-hidden">
                    {['AM', 'PM'].map((period) => (
                      <button
                        ...
                        className={`px-1.5 py-1 text-xs font-medium transition-all ${
              ...
              <div className="mt-2 p-2 bg-zinc-800/50 rounded-md border border-zinc-700/50">
