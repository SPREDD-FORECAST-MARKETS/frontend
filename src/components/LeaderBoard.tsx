    ...
    <div className="border border-zinc-800 w-1/2 rounded-xl">
      <div className="bg-gradient-to-b from-[#111] to-[#0a0a0a] rounded-xl p-6 shadow-lg flex-1">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-white text-3xl font-bold">Leaderboards</h2>
        ...
        {data.map((item) => (
          ...
          >
            ...
            <div className="flex-1 mr-4">
              <p className="text-white font-mono text-sm md:text-base group-hover:text-teal-100 transition-colors duration-300">
                {item.username}
              </p>
            </div>
