...
const TradingPanel = ({
 ...
 return (
  <div className="bg-gradient-to-b from-[#111] to-[#0a0a0a] rounded-2xl border border-zinc-800 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300">
    ...
    <div className="bg-transparent px-6 py-4 border-b border-zinc-800">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-400">Place your forecast</p>
        </div>
      </div>
    </div>
    ...
    {/* Outcome Selection */}
    <div className="p-6 border-b border-zinc-800">
      <h3 className="text-sm font-medium text-zinc-400 mb-4">Outcome</h3>
    ...
    <div className="p-6 border-b border-zinc-800">
      <div className="flex justify-between items-center mb-4">
        ...
        <span className="text-xs text-zinc-500">
          Available:{" "}
          {isBuy
            ? `$${userBalance?.value ? formatUnits(userBalance.value, userBalance.decimals!) : "0"}`
            : `${isYes ? userSharesYes : userSharesNo} shares`}
        </span>
      </div>
    ...
    <div className="p-6 border-b border-zinc-800 bg-zinc-900/50">
      <h3 className="text-sm font-medium text-zinc-400 mb-4">Trade Summary</h3>
